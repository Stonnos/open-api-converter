...
a|
<#if method.requestBody.exampleExternalRef??>
link:${method.requestBody.exampleExternalRef}[${method.requestBody.exampleExternalRefKey}]
<#elseif method.requestBody.example??>
[source,json]
----
